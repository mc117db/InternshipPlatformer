...
public class ComponentMovement : MonoBehaviour 
{
	...
	void Update()
    {
        m_grounded = Physics.Raycast(transform.position, -Vector3.up, m_distToGround+0.1f);
    }
	...
	void FixedUpdate () 
	{
        ...
        if (m_rigidbody)
        {
            ...
            m_rigidbody.AddForce(new Vector3(m_grounded ? moveX : moveX*AirControlDegree, 0, 0),ForceMode.VelocityChange);
